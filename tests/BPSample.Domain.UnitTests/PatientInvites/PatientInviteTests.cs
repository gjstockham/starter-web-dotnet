namespace BPSample.Domain.UnitTests.Organisations
{
    ...
    public class PatientInviteTests : IClassFixture<DataFixture>
    {
        ...
        {
            FluentActions.Invoking(() => new PatientInvite(null, "given", "family", "email", "sms"))
        ...
        {
            FluentActions.Invoking(() => new PatientInvite(new ChiNumber("9999999999"), null, "family", "email", "sms"))
                .Should().ThrowExactly<ArgumentNullException>("null").Which.ParamName.Should().Be("givenName");

            FluentActions.Invoking(() => new PatientInvite(new ChiNumber("9999999999"), "", "family", "email", "sms"))
        ...
        {
            FluentActions.Invoking(() => new PatientInvite(new ChiNumber("9999999999"), "given", null, "email", "sms"))
                .Should().ThrowExactly<ArgumentNullException>("null").Which.ParamName.Should().Be("familyName");

            FluentActions.Invoking(() => new PatientInvite(new ChiNumber("9999999999"), "given", "", "email", "sms"))
        ...
        {
            FluentActions.Invoking(() => new PatientInvite(new ChiNumber("9999999999"), "given", "family", null, "sms"))
                .Should().ThrowExactly<ArgumentNullException>("null").Which.ParamName.Should().Be("email");

            FluentActions.Invoking(() => new PatientInvite(new ChiNumber("9999999999"), "given", "family", "", "sms"))
